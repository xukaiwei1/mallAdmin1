...
public class MyFriendService {
    ...
    private final String myFollowCacheName = "myFollowList";
	private final String myFansCacheName = "myFansList";
	private final String followAndFansTotalCacheName = "followAndFansTotal";
