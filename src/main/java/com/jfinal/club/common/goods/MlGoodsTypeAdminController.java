 ...
 * 商品类型管理控制器
 */
public class MlGoodsTypeAdminController extends BaseController {


	@Inject
	MlGoodsTypeAdminService  mlGoodsTypeAdminService;
	...
	public void goodList() {
		...
		Page goodList = mlGoodsTypeAdminService.goodsList(getLoginAccount(),typeName,startTime,endTime,page,rows);
		renderJson(Ret.ok("msg", "查询成功").set("goodList",goodList));
	}
}
